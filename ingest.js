...
if (!SUPABASE_URL || !SUPABASE_SERVICE_ROLE_KEY || !GEMINI_API_KEY) {
  console.error('Missing required environment variables. Check your .env file has all three:');
...
// Must match the model and dimensions used in chat-api.js exactly, or
// similarity search between ingested chunks and live queries won't line up.
